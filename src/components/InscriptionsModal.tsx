...
export const InscriptionModal = ({
  ...
  const [inscription, setInscriptions] = useState<InscriptionResponse[]>([]);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Inscripciones: ${competitionName || 'Competencia'}`}>
          ...
          error ? (
            ...
            inscriptions.length === 0 ? (
                <div className="flex flex-1 flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-8 text-center">
                  ...
                  <p className="text-sm text-gray-500">Aún no hay participantes registrados en esta competencia.</p>
                </div>
              ) :
