...
function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Se guarda el token en el context (el rol se extrae del JWT)
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-center p-6">
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="w-full rounded-md border border-gray-300 p-2 pr-10 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none"
                  placeholder="••••••••"
                />
